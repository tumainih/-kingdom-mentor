/* Kingdom AI — offline-capable service worker (build yNUsNTKvlqoJ_L2cxp_i0) */
const CACHE = "kingdom-ai-yNUsNTKvlqoJ_L2cxp_i0";
const PRECACHE = [
  "/",
  "/home",
  "/history",
  ...
  "/data/areas/en/anger.json",
  "/data/areas/en/comfort.json",
  "/data/areas/en/courage.json",
  "/data/areas/en/doubt.json",
  "/data/areas/en/faith.json",
  "/data/areas/en/fear.json",
  "/data/areas/en/forgiveness.json",
  "/data/areas/en/grace.json",
  "/data/areas/en/grief.json",
  "/data/areas/en/guidance.json",
  "/data/areas/en/guilt.json",
  "/data/areas/en/hope.json",
  "/data/areas/en/joy.json",
  "/data/areas/en/love.json",
  "/data/areas/en/marriage.json",
  "/data/areas/en/mercy.json",
  "/data/areas/en/patience.json",
  "/data/areas/en/peace.json",
  "/data/areas/en/prayer.json",
  "/data/areas/en/security.json",
  "/data/areas/en/strength.json",
  "/data/areas/en/trust.json",
  "/data/areas/en/wisdom.json",
  "/data/areas/sw/anger.json",
  "/data/areas/sw/comfort.json",
  "/data/areas/sw/courage.json",
  "/data/areas/sw/doubt.json",
  "/data/areas/sw/faith.json",
  "/data/areas/sw/fear.json",
  "/data/areas/sw/forgiveness.json",
  "/data/areas/sw/grace.json",
  "/data/areas/sw/grief.json",
  "/data/areas/sw/guidance.json",
  "/data/areas/sw/guilt.json",
  "/data/areas/sw/hope.json",
  "/data/areas/sw/joy.json",
  "/data/areas/sw/love.json",
  "/data/areas/sw/marriage.json",
  "/data/areas/sw/mercy.json",
  "/data/areas/sw/patience.json",
  "/data/areas/sw/peace.json",
  "/data/areas/sw/prayer.json",
  "/data/areas/sw/security.json",
  ...
  "/_next/static/chunks/202jhjj3eubqj.js",
  ...
  "/_next/static/chunks/3_o6ihk11mu3a.js",
  "/_next/static/chunks/3adwt13tezgym.js",
  "/_next/static/chunks/3jr9i956-46ck.js",
  "/_next/static/chunks/3q576hlfnuh0n.js",
  "/_next/static/chunks/3wtl5qdkwgu5z.js",
  "/_next/static/chunks/41p7cbtr4b96s.js",
  ...
  "/_next/static/yNUsNTKvlqoJ_L2cxp_i0/_buildManifest.js",
  "/_next/static/yNUsNTKvlqoJ_L2cxp_i0/_clientMiddlewareManifest.js",
  "/_next/static/yNUsNTKvlqoJ_L2cxp_i0/_ssgManifest.js"
];
