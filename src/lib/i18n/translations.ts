...
export const translations = {
  en: {
    ...
    areasLoadMore: "Show more ({shown}/{total})",
    ...
    reportBack: "Back",
    reportYear: "Year",
    reportHalfYear: "6 months",
    reportQuarter: "3 months",
    reportMonth: "Month",
    reportWeek: "Week",
    reportDay: "Day",
    reportDays: "Days",
    reportMonthsGrid: "Months (4×3)",
    reportComposition: "Tap a block to reveal smaller units",
    reportDrillHint: "Tap the day to split into 12h → 6h → 3h → 1h",
    reportTapExpand: "Finished periods use the color scale. Tap to drill down or add a note.",
  ...
  sw: {
    ...
    areasLoadMore: "Onyesha zaidi ({shown}/{total})",
    ...
    reportBack: "Rudi",
    reportYear: "Mwaka",
    reportHalfYear: "Miezi 6",
    reportQuarter: "Miezi 3",
    reportMonth: "Mwezi",
    reportWeek: "Wiki",
    reportDay: "Siku",
    reportDays: "Siku",
    reportMonthsGrid: "Miezi (4×3)",
    reportComposition: "Gusa kisanduku kufichua vipande vidogo",
    reportDrillHint: "Gusa siku kugawanya 12h → 6h → 3h → 1h",
    reportTapExpand: "Vipindi vilivyokamilika vina rangi ya kiwango. Gusa kuchimba au kuongeza maelezo.",
    notifyDenied:
